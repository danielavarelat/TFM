...
FOLDERS = ["4_20190523_E1", "4_20190806_E3", "4_20190806_E4", "4_20190806_E6"]
if __name__ == "__main__":
    for folder in FOLDERS:
        ...
        vertices_location_spl = np.array([v for v in vertices_location_spl if (v[0] < dim_info["x_size"] and v[1] < dim_info["y_size"] and v[2] < dim_info["z_size"])])
        ...
        # indices_vertices_surface_spl = [
        #     i
        #     for i in indices_vertices_surface_spl
        #     if i not in indices_vertices_surface_myo
        # ]
        # indices_vertices_surface_myo = [
        #     i
        #     for i in indices_vertices_surface_myo
        #     if i not in indices_vertices_surface_spl
        # ]
