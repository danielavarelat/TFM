...
out_ext = ".h5"
algorithm_name = "GASP"
gasp_linkage_criteria = "mutex_watershed"  # "average"
beta = 0.5
ws_threshold = 0.5
ws_minsize = 30
ws_sigma = 0.8
...
if __name__ == "__main__":
    ...
    outfile = "/Users/dvarelat/Documents/MASTER/TFM/methods/postpro/crop0_original_XYZ_predictions_MUTEX_code.nii.gz"
    seg = main(PROB)
